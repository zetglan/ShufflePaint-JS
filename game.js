...
//var game;
	window.onload = function() {
		game = new Game(400, 250);
		game.fps = 60;
		game.score = 0;
		game.slctcond=1;//slctcond:選択中の色，1は赤，2は青，3は黄色
		game.level=1;	//ゲームの難度レベル(レベル5が最難)
				...
				game.addEventListener('enterframe', function () {
					...
					if(countdown>300 && gamecond){
						...
						if(getSlctCond(red,blue,yellow)!=ans){
							...
							//var quiz = new Sprite(114,114);	//スプライト生成
							quiz.image=game.assets[generateQuizImage(next_ans,quiz)];	//お題ナンバーをスプライト(画像)に反映
